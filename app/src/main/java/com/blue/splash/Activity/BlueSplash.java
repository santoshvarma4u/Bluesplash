package com.blue.splash.Activity;
...
import com.blue.splash.R;
import com.blue.splash.cnst.Flags;
import com.blue.splash.model.ConfigSplash;
import com.blue.splash.utils.UIUtil;
import com.blue.splash.utils.ValidationUtil;
...
abstract public class BlueSplash extends AppCompatActivity {
    ...
    public void initUI(int flag) {
        setContentView(R.layout.activity_blue_splash);
